...
struct UE_DEPRECATED(4.26, "APEX is deprecated. Destruction in future will be supported using Chaos Destruction.") FUpdateChunksInfo
{
	...
	FUpdateChunksInfo(int32 InChunkIndex, const FTransform & InWorldTM, const FVector& InLinearVel, const FVector& InAngularVel) 
		: ChunkIndex(InChunkIndex), WorldTM(InWorldTM), LinearVelocity(InLinearVel), AngularVelocity(InAngularVel)
	// end:@minyul
	{}
};
